    ...
    <div className="min-h-screen bg-cream selection:bg-primary selection:text-white">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <video
          ...
          className="absolute inset-0 w-full h-full object-cover z-0 grayscale-[0.1] opacity-80"
        >
          <source src="/hero-bg.mp4" type="video/mp4" />
        </video>
        <div className="absolute inset-0 bg-gradient-to-b from-white/60 via-white/20 to-cream/90 z-10"></div>
